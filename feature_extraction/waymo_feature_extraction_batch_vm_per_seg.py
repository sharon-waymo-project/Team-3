...
if __name__ == "__main__":
    ...
    fs = [f for f in listdir(seg_path) if isfile(join(seg_path, f)) and ".tfrecord" in f]
    ...
    for i in range(len(fs)):
      ...
      print("filename:", f, "Num of frames:", len(frames))
      ...
      print("Progress: ", i, "/", len(fs))

      result_path = join(result_dir, fs[i].split('.')[0] + ".csv")
      print("Result can be found at:", result_path)
      write_to_csv(result_path, feats, labels)
